...
class RepentancesControllerTest < ActionController::TestCase
  ...
  test "should create repentance" do
    assert_difference('Repentance.count') do
      post :create, repentance: { charity_id: @repentance.charity_id, monetary_donation: @repentance.monetary_donation, sin_id: @repentance.sin_id, time_donation: @repentance.time_donation }
    end
  ...
  test "should update repentance" do
    put :update, id: @repentance, repentance: { charity_id: @repentance.charity_id, monetary_donation: @repentance.monetary_donation, sin_id: @repentance.sin_id, time_donation: @repentance.time_donation }
    assert_redirected_to repentance_path(assigns(:repentance))
  end
