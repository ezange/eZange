...
class JudgementsControllerTest < ActionController::TestCase
  ...
  test "should create judgement" do
    assert_difference('Judgement.count') do
      post :create, judgement: { judgement_date: @judgement.judgement_date, judgement_time: @judgement.judgement_time, jugement: @judgement.jugement, memebr_id: @judgement.memebr_id, sin_id: @judgement.sin_id }
    end
  ...
  test "should update judgement" do
    put :update, id: @judgement, judgement: { judgement_date: @judgement.judgement_date, judgement_time: @judgement.judgement_time, jugement: @judgement.jugement, memebr_id: @judgement.memebr_id, sin_id: @judgement.sin_id }
    assert_redirected_to judgement_path(assigns(:judgement))
  end
