...
class CharitiesControllerTest < ActionController::TestCase
  ...
  test "should create charity" do
    assert_difference('Charity.count') do
      post :create, charity: { charity_city: @charity.charity_city, charity_country: @charity.charity_country, charity_name: @charity.charity_name, charity_phone_number: @charity.charity_phone_number, charity_state: @charity.charity_state, charity_street_name: @charity.charity_street_name, charity_street_number: @charity.charity_street_number, charity_type: @charity.charity_type, charity_zip: @charity.charity_zip }
    end
